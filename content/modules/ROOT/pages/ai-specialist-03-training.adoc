...
kind: Task
metadata:
  creationTimestamp: '2025-05-12T11:58:39Z'
  generation: 1
  managedFields:
    - apiVersion: tekton.dev/v1
      fieldsType: FieldsV1
      ...
      manager: Mozilla
      operation: Update
      time: '2025-05-12T11:58:39Z'
  name: modelcar-build-and-push
  namespace: user99-tools
  resourceVersion: '347909'
  uid: 5f24b038-079a-4ac3-85f4-00e412aaf4f3
spec:
  params:
    ...
    - computeResources: {}
      ...
      script: |
        ...
        for arch in $(echo $(params.PLATFORMS) | tr ',' ' '); do
          ...
          podman build --arch ${arch##*/} -f $(params.DOCKERFILE) -t $(params.IMAGE)-$tag $(params.CONTEXT)
