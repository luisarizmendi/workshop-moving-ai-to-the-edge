...
def yolo_training_pipeline_cpu(
...
if __name__ == "__main__":
    ...
    compiler.Compiler().compile(
        pipeline_func=yolo_training_pipeline_cpu,
        package_path='yolo_training_pipeline_cpu.yaml'
    )
    print("Pipeline compiled successfully to yolo_training_pipeline_cpu.yaml")
