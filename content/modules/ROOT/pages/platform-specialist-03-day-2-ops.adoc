...
. Create a new OpenShift Project (`{user}-ai-test`)
...
Go to Routes in the https://console-openshift-console.apps.{ocp_cluster_url}[OpenShift Console] and take note of the Backend and Frontend URLs
