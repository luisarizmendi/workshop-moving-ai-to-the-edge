...
Remember that you performed a Mock Training with a reduced number of epochs and few data, so you cannot use that model to detect hardhats. During the deployment phase you will use a https://huggingface.co/luisarizmendi/hardhat-or-hat[provided pre-trained model].
