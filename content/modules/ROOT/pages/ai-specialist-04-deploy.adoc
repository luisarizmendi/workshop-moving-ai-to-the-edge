...
1- Go to the to https://console-openshift-console.apps.{ocp_cluster_url}[OpenShift Console]

2- Click on the `+` button on the top right corner of the UI to deploy a new YAML file

3- Be sure that you are in the right project (`{user}-ai-test` if you used the recommended name) and paste the following YAML
