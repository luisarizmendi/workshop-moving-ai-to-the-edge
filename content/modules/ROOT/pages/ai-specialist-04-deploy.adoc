...
6- When all pods are running, go to "Routes" and you will be able to open the Dashboard using the Frontend URL. You will see an empty page with the "Device Monitoring Dashboard" title.
