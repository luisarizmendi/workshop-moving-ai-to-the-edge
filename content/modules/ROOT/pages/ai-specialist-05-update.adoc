...
You have a https://huggingface.co/luisarizmendi/hardhat-or-hat[second verion of the pre-trained model] that includes the hat detections that you can directly use instead of waiting to train your own model.
