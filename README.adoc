= Personal Protection Equipment detection with Red Hat Device Edge
...
You can take a view to the content by simply visiting GitHub Pages for this repo in `https://luisarizmendi.github.io/workshop-moving-ai-to-the-edge/modules/index.html`
