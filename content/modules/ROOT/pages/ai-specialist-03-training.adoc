...
However, probably you used a reduced dataset ("xref:ai-specialist-01-data.adoc#_mock_training_dataset[*Mock Training*]") or limited epochs for faster training 
